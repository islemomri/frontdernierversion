...
selectedEmployes: any[] = [];
  ...
  private transformToFormationDtocalendrier(data: any): FormationDto {
    return {
      ...
      dateDebutPrevue: this.ensureISODateString(data.date_debut_prevue),
      dateFinPrevue: this.ensureISODateString(data.date_fin_prevue),
      responsableEvaluationId: data.responsable_evaluation_id || null,
      responsableEvaluationExterne: data.responsable_evaluation_externe || null,
      employeIds: data.employeIds || [],
      responsableEvaluation: data.responsable_evaluation || null,
      employes: data.employes || [],
      fichierPdf: data.fichier_pdf || null,
      organisateurId: data.organisateur_id,
      titrePoste: data.titre_poste || null,
...
isInProgress(dateFinPrevue: Date): boolean {
  ...
  private transformToFormationDto(data: any): FormationDto {
    return {
      ...
      typeFormation: data.type_formation,
      sousTypeFormation: data.sous_type_formation,
      dateDebutPrevue: data.date_debut_prevue,
...
updateResultat(formationId: number, employeId: number, resultat: string, employe: any) {
  ...
  if (this.selectedFormation?.sousTypeFormation === 'POLYCOMPETENCE') {
    ...
    // Pour les autres formations, garder la logique actuelle avec confirmation
